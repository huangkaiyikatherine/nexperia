...
parser.add_argument('--ecoc1', default=0, type=int,
                    help='trained_label for class 1')
parser.add_argument('--ecoc2', default=1, type=int,
                    help='trained_label for class 2')
parser.add_argument('--ecoc3', default=2, type=int,
                    help='trained_label for class 3')
parser.add_argument('--ecoc4', default=3, type=int,
                    help='trained_label for class 4')
parser.add_argument('--ecoc5', default=4, type=int,
                    help='trained_label for class 5')
parser.add_argument('--ecoc6', default=5, type=int,
                    help='trained_label for class 6')
parser.add_argument('--ecoc7', default=6, type=int,
                    help='trained_label for class 7')
parser.add_argument('--ecoc8', default=7, type=int,
                    help='trained_label for class 8')
parser.add_argument('--ecoc9', default=8, type=int,
                    help='trained_label for class 9')
parser.add_argument('--ecoc10', default=9, type=int,
                    help='trained_label for class 10')
...
def main():
    ...
    length = len(np.unique([args.ecoc1, args.ecoc2, args.ecoc3, args.ecoc4, args.ecoc5,
                            args.ecoc6, args.ecoc7, args.ecoc8, args.ecoc9, args.ecoc10]))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train(train_loader, model, criterion, optimizer, epoch, train_timeline, args.sat_es, args.dataset, args.mod, args.crop,
             ecoc=[args.ecoc1, args.ecoc2, args.ecoc3, args.ecoc4, args.ecoc5,
                   args.ecoc6, args.ecoc7, args.ecoc8, args.ecoc9, args.ecoc10])
        print("*" * 40)
...
def train(train_loader, model, criterion, optimizer, epoch, timeline, es, dataset, mod=None, crop='center',
    ...
    if dataset=='nexperia':
        for i, ((input, target, idx, image_id), index) in enumerate(train_loader):
...
def validate(val_loader, model, epoch, timeline, dataset, state=None, criterion=None, last=False, crop='center', ecoc=None):
    """
    Run evaluation
    """
    batch_time = AverageMeter()
