...
# 	filename = '{}_{}_{}_{}_r{}_lambda{}_{}_huber_lasso_wrong_indices.csv'.format(
# 		args.dataset, args.arch, args.loss, args.noise_type, args.noise_rate, args.lambd, args.lr_schedule)
# 	np.savetxt(os.path.join('/home/kaiyihuang/giants_shoulder/self-adaptive-training-master/logs',filename), wrong_indices, delimiter=",")
