...
class ConcatDataset(torch.utils.data.ConcatDataset):
    def __init__(self, datasets):
        ...
        self.classes = ['chipping', 'device_flip', 'empty_pocket', 'foreign_material', 'good',
                        'lead_defect', 'lead_glue', 'marking_defect', 'pocket_damage', 'scratch', 'tin_particles']
    ...
    def __getitem__(self, idx):
        ...
        if dataset_idx == 0:
            ...
            if self.datasets[dataset_idx][sample_idx][1]>=8:
                return self.datasets[dataset_idx][sample_idx], idx, self.datasets[dataset_idx][sample_idx][1]+1
        return self.datasets[dataset_idx][sample_idx], idx, self.datasets[dataset_idx][sample_idx][1]